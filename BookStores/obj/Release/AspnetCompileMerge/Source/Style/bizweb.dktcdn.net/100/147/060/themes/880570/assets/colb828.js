	...
	filter.search({
		...
		success: function (html) {
			...
			$('.sort-cate .evo-filter').click(function(){
				$('.collection .evo-filter-cate, .collection-grid .evo-filter-cate').toggleClass('active');
				$(this).toggleClass('active');
				if ($(window).width() < 768) {
					$('.collection.evo-colabc .sort-cate-left h3, .collection .sort-cate-left ul, .collection-grid .sort-cate-left ul').removeClass('active');
				}
			});
			if ($(window).width() < 768) {
				$('.sort-cate-left h3').on('click', function(e){
					...
					$(this).toggleClass('active');
					$('.collection .evo-filter-cate, .collection .evo-filter, .collection-grid .evo-filter, .collection-grid .evo-filter-cate').removeClass('active');
					return false;
				});
			}
